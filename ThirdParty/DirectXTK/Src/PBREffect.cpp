...
namespace
{
    ...
    struct PBREffectConstants
    {
        ...
        XMMATRIX prevWorldViewProj; // for velocity_magn generation
...
const int EffectBase<PBREffectTraits>::VertexShaderIndices[] =
{
    ...
    1,      // textured + velocity_magn
    1,      // textured + emissive + velocity_magn
    ...
    3,      // textured + velocity_magn (biased vertex normals)
    3,      // textured + emissive + velocity_magn (biased vertex normals)
};
...
const int EffectBase<PBREffectTraits>::PixelShaderIndices[] =
{
    ...
    3,      // textured + velocity_magn
    4,      // textured + emissive + velocity_magn
    ...
    3,      // textured + velocity_magn (biased vertex normals)
    4,      // textured + emissive + velocity_magn (biased vertex normals)
};
#pragma endregion
...
int PBREffect::Impl::GetCurrentShaderPermutation() const noexcept
{
    ...
    {
        // Optional velocity_magn buffer (implies textured).
        permutation += 9;
    }
...
void PBREffect::Impl::Apply(_In_ ID3D11DeviceContext* deviceContext)
{
    ...
    // Store old wvp for velocity_magn calculation in shader
