...
namespace SE_G {
    namespace Bind {
        VertexBuffer::VertexBuffer(ID3D11Device* device, const void* data,
            ...
            : count(count), slot(slot), type(type)
        {
            ...
            if (type == VertexBuffer::VBType::SINGLE)
            {
            ...
            else if (type == VertexBuffer::VBType::INSTANCED_CPU)
            {
        ...
        void VertexBuffer::Update(ID3D11DeviceContext* context, const void* data)
        {
        ...
        void VertexBuffer::Update(ID3D11DeviceContext* context, ID3D11Buffer* inputResource)
        {
            if (type == VBType::INSTANCED_CPU)
            {
                /*
