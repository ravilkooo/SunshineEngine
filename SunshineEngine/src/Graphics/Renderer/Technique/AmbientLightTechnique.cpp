...
namespace SE_G {
    AmbientLightTechnique::AmbientLightTechnique(ID3D11Device* device, TransformComponent* assignedTransform, eastl::string technique,
        ...
        AssetPath shaderPath = AssetPath(L"Shaders/LightPass/AmbientLightVShader.hlsl", AssetPath::AssetSource::Engine);
        ...
        shaderPath = AssetPath(L"Shaders/LightPass/AmbientLightPShader.hlsl", AssetPath::AssetSource::Engine);
