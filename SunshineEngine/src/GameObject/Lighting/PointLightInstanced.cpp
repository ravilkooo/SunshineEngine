    ...
    : lightsCnt(lightsCnt)
{
    ...
    // LightPass
    {
        ...
        // AddStaticBind(texture);
        Bind::VertexShader* vertexShaderB = new Bind::VertexShader(device, L"Shaders/GPass/PointLightInstancedGBufferVS.hlsl");
        ...
        gPass->AddBind(instanceBuffer);

        gPass->AddBind(new Bind::PixelShader(device, L"Shaders/GPass/PointLightInstancedGBufferPS.hlsl"));
