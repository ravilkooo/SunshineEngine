...
inline void to_json(json& j, const BoxShapeData& obj) {
	j = json{
		{ "UvCubeMapMode", obj.UvCubeMapMode }
	};
}

inline void from_json(const json& j, BoxShapeData& obj) {
	// j.at("Size").get_to(obj.Size);
	if (j.contains("UvCubeMapMode"))
		j.at("UvCubeMapMode").get_to(obj.UvCubeMapMode);
}
...
inline void to_json(json& j, const PlaneShapeData& obj) {
	j = json{
	};
}

inline void from_json(const json& j, PlaneShapeData& obj) {
