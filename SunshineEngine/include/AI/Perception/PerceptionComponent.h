...
public:
    ...
    bool SetEyesOffset(DXSM::Vector3 NewEyesOffset)            { EyesOffset = NewEyesOffset; };
...
#ifndef PERCEPTIONCOMPONENT_LUA_FIELDS_APPLY
#define PERCEPTIONCOMPONENT_LUA_FIELDS_APPLY(F) \
    F(CanSee) , \
    F(CanHear)
#endif
